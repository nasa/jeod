...
if(TRICK_BUILD)
   if(NOT DEFINED TRICK_HOME)
      if(NOT DEFINED ENV{TRICK_HOME})
         message(FATAL_ERROR "TRICK_BUILD set but TRICK_HOME not defined in environment or passed via -DTRICK_HOME=")
      else()
   ...
   if(NOT DEFINED ER7_UTILS_HOME)
      if(NOT DEFINED ENV{ER7_UTILS_HOME})
         if(NOT DEFINED TRICK_HOME)
           if(NOT DEFINED ENV{TRICK_HOME})
              message(FATAL_ERROR "NON-TRICK_BUILD detected but ER7_UTILS_HOME or TRICK_HOME not defined in environment or passed via -DER7_UTILS_HOME= or -DTRICK_HOME=")
           else()
              set(ER7_UTILS_HOME $ENV{TRICK_HOME}/trick_source)
           endif()
         else()
