...
if(USE_TRICK_MATH)
   if(NOT DEFINED TRICK_HOME)
      if(NOT DEFINED ENV{TRICK_HOME})
         ...
         if(NOT DEFINED TRICK_HOME)
            message(FATAL_ERROR "ENABLE_UNIT_TESTS and USE_TRICK_MATH set but TRICK_HOME not available. It can be defined in environment, passed via -DTRICK_HOME=, or TRICK_HOME/bin can be added to PATH.")
         endif()
