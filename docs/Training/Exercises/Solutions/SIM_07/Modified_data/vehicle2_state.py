vehicle2.trans_init.set_subject_body( vehicle2.dyn_body )
...
vehicle2.rot_init.set_subject_body( vehicle2.dyn_body )
...
vehicle2.rot_init.ang_velocity             = trick.sim_services.attach_units("degree/s" , [0.0, 0.0, -36.0])
