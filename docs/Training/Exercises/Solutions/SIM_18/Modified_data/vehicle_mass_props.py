...
vehicle.mass_init.points[0].name = "exercise 18 vehicle point"
...
##
#vehicle.mass_init.points[0].pt_orientation.data_source=trick.Orientation.InputMatrix
#vehicle.mass_init.points[0].pt_orientation.trans[0]  = [ -1.0,  0.0, 0.0]
#vehicle.mass_init.points[0].pt_orientation.trans[1]  = [  0.0, -1.0, 0.0]
#vehicle.mass_init.points[0].pt_orientation.trans[2]  = [  0.0,  0.0, 1.0]
##
#vehicle.mass_init.points[0].pt_orientation.data_source=trick.Orientation.InputEulerRotation
#vehicle.mass_init.points[0].pt_orientation.euler_sequence = trick.Orientation.YawPitchRoll
#vehicle.mass_init.points[0].pt_orientation.euler_angles = trick.attach_units( "degree",[180.0, 0.0, 0.0])
##
