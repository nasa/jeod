...
trick.add_read(0.0 , """
vehicleA.body.print_tree ( "SET_test/RUN_test/initialization.out", 100 )
""")
...
vehicleA.body.print_tree ( "SET_test/RUN_test/fifty_percent.out", 100 )
""")
...
vehicleB.tank.set_update_flag()
vehicleA.body.update_mass_properties()
vehicleA.body.print_tree ( "SET_test/RUN_test/eighty-percent.out", 100 )
""")
...
vehicleB.tank.set_update_flag()
vehicleA.body.update_mass_properties()
vehicleA.body.print_tree ( "SET_test/RUN_test/ninety-percent.out", 100 )
""")
...
vehicleB.tank.set_update_flag()
vehicleA.body.update_mass_properties()
vehicleA.body.print_tree ( "SET_test/RUN_test/hundred-percent.out", 100 )
""")
