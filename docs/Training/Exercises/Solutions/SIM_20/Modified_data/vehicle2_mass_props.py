...
vehicle2.mass_init.properties.pt_orientation.eigen_angle = trick.attach_units("degree", 90.0)
vehicle2.mass_init.properties.pt_orientation.eigen_axis  = [0.0, 0.0, -1]


vehicle2.mass_init.allocate_points(1)
vehicle2.mass_init.get_mass_point(0).name = "vehicle2_point"
vehicle2.mass_init.get_mass_point(0).position  = [0.0, 1.0, 0.0]

vehicle2.mass_init.get_mass_point(0).pt_orientation.data_source=trick.Orientation.InputEigenRotation
vehicle2.mass_init.get_mass_point(0).pt_orientation.eigen_angle = trick.attach_units( "degree",90.0)
vehicle2.mass_init.get_mass_point(0).pt_orientation.eigen_axis = [0,0,1]
