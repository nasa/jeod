...
trick.add_read(0, """
vehicle2.dyn_body.mass.find_mass_point("vehicle2_point").compute_relative_state (
                                  vehicle2.dyn_body.mass.core_properties,
                                  states.point_state)
vehicle2.dyn_body.core_body.compute_relative_state(
                                  vehicle.dyn_body.core_body,
                                  states.body_body_frame_state)
vehicle2.dyn_body.find_vehicle_point("vehicle2_point").compute_relative_state (
                                  vehicle.dyn_body.core_body,
                                  states.body_point_frame_state)
vehicle2.dyn_body.find_vehicle_point("vehicle2_point").compute_relative_state (
                                  vehicle.dyn_body.find_vehicle_point("vehicle_point"),
                                  states.point_point_frame_state)
""")
