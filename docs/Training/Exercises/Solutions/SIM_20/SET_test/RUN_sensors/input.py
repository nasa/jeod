...
exec(compile(open("Modified_data_sensors/vehicle_mass_props.py", "rb").read(), "Modified_data_sensors/vehicle_mass_props.py", 'exec'))
exec(compile(open("Modified_data_sensors/vehicle_state.py", "rb").read(), "Modified_data_sensors/vehicle_state.py", 'exec'))
exec(compile(open("Modified_data_sensors/vehicle2_mass_props.py", "rb").read(), "Modified_data_sensors/vehicle2_mass_props.py", 'exec'))
exec(compile(open("Modified_data_sensors/vehicle2_state.py", "rb").read(), "Modified_data_sensors/vehicle2_state.py", 'exec'))
