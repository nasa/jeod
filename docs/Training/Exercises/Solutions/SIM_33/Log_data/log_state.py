...
def log_state ( log_cycle ) :
  ...
  dr_group.add_variable( "state.orb_elem.elements.e_mag")
  dr_group.add_variable( "state.orb_elem.elements.semi_major_axis")
  dr_group.add_variable( "state.orb_elem.elements.inclination")
  dr_group.add_variable( "state.orb_elem.elements.true_anom")
