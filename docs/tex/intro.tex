...
JEOD has been used for years by the Space Shuttle Program and the International Space Station and now is planned for use by other programs including Training Systems for the 21st Century (TS21), Commercial Off the Shelf (COTS), Orion, and Space Exploration Vehicle (SEV).
