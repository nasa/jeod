...
class DynBodyInit : public BodyAction {
   ...
   JEOD_MAKE_SIM_INTERFACES(DynBodyInit)
 ...
 private:
   ...
   DynBodyInit (const DynBodyInit&);
   DynBodyInit & operator = (const DynBodyInit&);
 ...
 protected:
   ...
   void apply_user_inputs (void);

   // compute_rotational_state: Obsolete. Do not call.
   void compute_rotational_state (void);

   // compute_translational_state: Obsolete. Do not call.
   void compute_translational_state (void);
