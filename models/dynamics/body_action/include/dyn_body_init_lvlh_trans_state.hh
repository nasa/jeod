 ...
 * @{
 *
 * @file models/dynamics/body_action/include/dyn_body_init_lvlh_trans_state.hh
 * Define the class DynBodyInitLvlhTransState, which initialize a vehicle's
 * translational state with respect to some other vehicle's LVLH frame.
 */
...
Library dependencies:
  ((../src/dyn_body_init_lvlh_trans_state.cc))
