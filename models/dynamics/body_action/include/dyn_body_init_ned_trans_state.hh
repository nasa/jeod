 ...
 * @{
 *
 * @file models/dynamics/body_action/include/dyn_body_init_ned_trans_state.hh
 * Define the class DynBodyInitNedTransState, which initialize a vehicle's
 * translational state wrt some other vehicle's North-East-Down frame.
 */
