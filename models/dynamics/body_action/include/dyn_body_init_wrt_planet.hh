 ...
 * @{
 *
 * @file models/dynamics/body_action/include/dyn_body_init_wrt_planet.hh
 * Define the class DynBodyInitWrtPlanet, the base class for initializing
 * selected aspects of a vehicle's state with respect to some state that is
 * connected to a planet in some way.
 */
...
Library dependencies:
  ((../src/dyn_body_init_wrt_planet.cc))
