...
def set_ISS_mass(vehicle_reference, dynamics) :
  ...
  vehicle_reference.mass_init.get_mass_point(0).position  = [ 9.844, 0.000, 5.282]
  vehicle_reference.mass_init.get_mass_point(0).pt_orientation.trans[0]  = [ 0.0,  0.0, 1.0]
  vehicle_reference.mass_init.get_mass_point(0).pt_orientation.trans[1]  = [ 0.0, -1.0, 0.0]
  vehicle_reference.mass_init.get_mass_point(0).pt_orientation.trans[2]  = [ 1.0,  0.0, 0.0]
