################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_ISS_trans_Orbit_inertial_body_set04
####################################################################################
...
#
#Purpose:
#  (Specify ISS orbit, J2000 reference, set #04,
...
def set_ISS_trans_Orbit_inertial_body_set04(vehicle_reference, dynamics) :
