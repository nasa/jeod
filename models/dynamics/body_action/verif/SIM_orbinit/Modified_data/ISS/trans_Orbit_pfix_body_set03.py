################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_ISS_trans_Orbit_pfix_body_set03
####################################################################################
...
#
#Purpose:
#  (Specify ISS orbit, planet-fixed reference, set #03,
...
def set_ISS_trans_Orbit_pfix_body_set03(vehicle_reference, dynamics) :




  vehicle_reference.orb_init.dyn_subject = vehicle_reference.dyn_body
  vehicle_reference.orb_init.action_name = "ISS.trans_Orbit_pfix_body_set03"
  ...
  vehicle_reference.orb_init.semi_latus_rectum  = trick.attach_units( "km",6732.88998827)
