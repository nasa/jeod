################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_STS_114_trans_Orbit_inertial_body_set01
####################################################################################
...
#
#Purpose:
#  (Specify STS-114 orbit, J2000 reference, set #01,
...
def set_STS_114_trans_Orbit_inertial_body_set01(vehicle_reference, dynamics) :

  vehicle_reference.orb_init.set_subject_body( vehicle_reference.dyn_body )
  vehicle_reference.orb_init.action_name = "STS_114.trans_Orbit_inertial_body_set01"
  ...
  vehicle_reference.orb_init.time_periapsis  = trick.attach_units( "s",4541.07695545)
