################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_STS_114_trans_Orbit_inertial_body_set02
####################################################################################
...
#
#Purpose:
#  (Specify STS-114 orbit, J2000 reference, set #02,
...
def set_STS_114_trans_Orbit_inertial_body_set02(vehicle_reference, dynamics) :

  vehicle_reference.orb_init.dyn_subject = vehicle_reference.dyn_body
  vehicle_reference.orb_init.action_name = "STS_114.trans_Orbit_inertial_body_set02"
  ...
  vehicle_reference.orb_init.mean_anomaly  = trick.attach_units( "degree",297.384539858)
