################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_STS_114_trans_Orbit_inertial_body_set03
####################################################################################
...
#
#Purpose:
#  (Specify STS-114 orbit, J2000 reference, set #03,
...
def set_STS_114_trans_Orbit_inertial_body_set03(vehicle_reference, dynamics) :


  vehicle_reference.orb_init.dyn_subject = vehicle_reference.dyn_body
  vehicle_reference.orb_init.action_name = "STS_114.trans_Orbit_inertial_body_set03"
  ...
  vehicle_reference.orb_init.semi_latus_rectum  = trick.attach_units( "km",6732.15350403)
