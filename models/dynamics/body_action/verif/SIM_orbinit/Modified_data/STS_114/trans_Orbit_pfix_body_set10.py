################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_STS_114_trans_Orbit_pfix_body_set10
####################################################################################
...
#
#Purpose:
#  (Specify STS-114 orbit, planet-fixed reference, set #10,
...
def set_STS_114_trans_Orbit_pfix_body_set10(vehicle_reference, dynamics) :




  vehicle_reference.orb_init.dyn_subject = vehicle_reference.dyn_body
  vehicle_reference.orb_init.action_name = "STS_114.trans_Orbit_pfix_body_set10"
