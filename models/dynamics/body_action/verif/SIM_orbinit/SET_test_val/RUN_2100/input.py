## Long test name: RUN_ISS_att_RotState_inertial_tbody_rate_RotState_inertial_tbody
################################################################################
#
# Purpose:
...
options["TARGET_ATT"] = "att_RotState_inertial_body"
options["TARGET_RATE"] = "rate_RotState_inertial_body"
