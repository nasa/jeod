...
attachTarget = trick.BodyAttachAligned()
attachTarget.set_subject_body(target.dyn_body)
attachTarget.set_parent_frame(earth.planet.inertial)
attachTarget.subject_point_name = "attach1"
attachTarget.parent_point_name = "Earth.pfix"
