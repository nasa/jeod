def attach1_default():
  ...
  components.attach1.subject     = components.child1_body
  components.attach1.parent      = components.parent_body
...
def attach1_optionB():
  components.attach1.subject  = components.child2_body
  components.attach1.parent   = components.child1_body
