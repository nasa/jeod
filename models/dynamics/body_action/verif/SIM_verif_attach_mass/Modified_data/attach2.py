def attach2_default():
  ...
  components.attach2.subject     = components.child2_body
  components.attach2.parent      = components.parent_body
...
def attach2_optionA():
  components.attach2.subject     = components.child3_body
  components.attach2.parent      = components.child2_body
...
def pt_attach2_default():
  ...
  components.pt_attach2.parent      = components.parent_body
