def attach3_default():
  ...
  components.attach3.subject     = components.child3_body
  components.attach3.parent      = components.parent_body
...
def pt_attach3_default():
  ...
  components.pt_attach3.subject     = components.child3_body
  components.pt_attach3.parent      = components.parent_body
