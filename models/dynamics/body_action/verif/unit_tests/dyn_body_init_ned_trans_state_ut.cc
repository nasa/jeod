...
class DynBodyInitNedTransStateTest : public DynBodyInitNedTransState
{
public:
...
TEST(DynBodyInitNedTransState, create)
{
    DynBodyInitNedTransState * dynInst;
    dynInst = new DynBodyInitNedTransState();
...
TEST(DynBodyInitNedTransState, initialize)
{
    ...
    {
        // nominal
        DynBodyInitNedTransStateTest dynInst;
