...
class DerivedStateMessages {
 ...
 JEOD_MAKE_SIM_INTERFACES(DerivedStateMessages)
 ...
 private:
   ...
   DerivedStateMessages (void);
   DerivedStateMessages (const DerivedStateMessages &);
   DerivedStateMessages & operator= (const DerivedStateMessages &);
