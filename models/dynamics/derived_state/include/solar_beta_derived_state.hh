...
{
    JEOD_MAKE_SIM_INTERFACES(jeod, SolarBetaDerivedState)
...
public:
    // Default constructor
    SolarBetaDerivedState() = default;
    ~SolarBetaDerivedState() override;
    SolarBetaDerivedState(const SolarBetaDerivedState &) = delete;
    SolarBetaDerivedState & operator=(const SolarBetaDerivedState &) = delete;
