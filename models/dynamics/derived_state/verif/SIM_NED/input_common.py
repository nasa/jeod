...
veh_state( vehA)
veh_state( vehB)
# Set vehB to trail vehA
vehB.init_orbit.true_anomaly  = trick.attach_units( "degree",359.0)


vehA.ned.reference_name = "Earth"
vehB.ned.reference_name = "Earth"

vehA.ned.ned_state.altlatlong_type = trick.NorthEastDown.elliptical
vehB.ned.ned_state.altlatlong_type = trick.NorthEastDown.elliptical

rel_state.vehA_wrt_vehB.subject_frame_name = "vehicleA.composite_body"
rel_state.vehA_wrt_vehB.target_frame_name  = "vehicleB.Earth.ned"
...
rel_state.vehB_wrt_vehA.target_frame_name  = "vehicleA.Earth.ned"
