#/*****************************************************************************
#           Run #6D: Maneuver Burn Comparison: Departure Maneuver
#******************************************************************************
#
#Run Scenario:
#   Model Setup -
...
#      Add'l notes:          Applied force on x-axis; initially aligned with LVLH
#
#
#
#
...
# Begin maneuver.
trick.add_read(1000.0, "vehicle.force_extern.force  = [ 66400.0, 0.0, 0.0]")
# End maneuver
