...
veh1.attach_to_2.subject            = veh1.dyn_body.mass
veh1.attach_to_2.parent             = veh2.dyn_body.mass
...
veh1.attach_to_2b.dyn_subject        = veh1.dyn_body
veh1.attach_to_2b.parent             = veh2.dyn_body.mass
...
veh1.attach_to_3.subject            = veh1.dyn_body.mass
veh1.attach_to_3.dyn_parent         = veh3.dyn_body
...
veh1.detach_from_2.dyn_subject = veh1.dyn_body
...
veh1.detach_from_3.subject     = veh1.dyn_body.mass
veh1.detach_from_3.dyn_detach_from = veh3.dyn_body
