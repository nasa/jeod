...
payload.attach_primary_to_veh.set_subject_body( payload.primary_body )
payload.attach_primary_to_veh.set_parent_body( veh.dyn_body )
...
payload.attach_secondary_to_primary.set_subject_body( payload.secondary_mass )
payload.attach_secondary_to_primary.set_parent_body( payload.primary_body )
