...
JEOD_MAKE_SIM_INTERFACES(BaseDynManager)
...
public:
   ...
   */
   ...
   virtual bool is_integ_group_registered (
      const DynamicsIntegrationGroup * integ_group) const = 0;
   ...
   virtual void reset_integrators (
           DynamicsIntegrationGroup & integ_group) = 0;
