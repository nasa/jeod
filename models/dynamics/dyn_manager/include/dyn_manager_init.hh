...
public:
     ...
     */
    EphemerisMode mode{EphemerisMode_Ephemerides}; //!< trick_units(--)

    /**
     * Name of central point, used when the manager operates in empty space
     * or single planet mode.
     */
    std::string central_point_name{""}; //!< trick_units(--)
     ...
     */
    er7_utils::Integration::Technique jeod_integ_opt{er7_utils::Integration::Unspecified}; //!< trick_units(--)
     ...
     * See the integ_constructor documentation for usage.
     */
    int sim_integ_opt{-1}; //!< trick_units(--)
