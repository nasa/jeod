...
JEOD_MAKE_SIM_INTERFACES(DynamicsIntegrationGroup)
public:
   ...
   explicit DynamicsIntegrationGroup (
   ...
   */
   ...
   virtual DynamicsIntegrationGroup * create_group (
      JeodIntegrationGroupOwner & owner,
      er7_utils::IntegratorConstructor & integ_cotr,
      JeodIntegratorInterface & integ_inter,
      JeodIntegrationTime & time_mngr)
   ...
   virtual void prepare_for_integ_loop (
      double sim_endtime);
...
protected:
    ...
    */
   bool bodies_integrated_separately; //!< trick_units(--)
