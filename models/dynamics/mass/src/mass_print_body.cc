 ...
 */
void MassBody::print_body(FILE * file_ptr, int levels) const
{
    ...
    fprintf(file_ptr, "\nC.M.P. Mass [kg]:\n % 20lf", this->composite_properties.mass);
    ...
    fprintf(file_ptr,
            ...
            "-------------------------------------------------------------");
    fprintf(file_ptr, "\nDerived Items");
    fprintf(file_ptr, "\nC.M.P. Inverse mass [1/kg]:\n % 20lf", this->composite_properties.inverse_mass);
    ...
    if(levels > 0)
    {
        ...
        for(auto * link : TreeLinksChildrenRange<const MassBodyLinks>(links))
        {
