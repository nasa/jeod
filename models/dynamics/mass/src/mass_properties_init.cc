 ...
 */
void MassPropertiesInit::initialize_mass_properties(MassProperties & properties) const
{
    ...
    switch(inertia_spec)
    {
        ...
        case StructCG:
            ...
            Matrix3x3::transform_matrix(properties.T_parent_this, inertia, properties.inertia);
            break;
        ...
        case Struct:
            ...
            MassBody::compute_point_mass_inertia(properties.mass, properties.position, offset_inertia);

            // Translate the input inertia to the CoM.
            Matrix3x3::subtract(inertia, offset_inertia, offset_inertia);

            // Transform to body.
            Matrix3x3::transform_matrix(properties.T_parent_this, offset_inertia, properties.inertia);
            break;
        ...
        case SpecCG:
        {
            ...
            Matrix3x3::transform_matrix(orientation.trans, inertia, properties.inertia);
            break;
        }
        ...
        case Spec:
        {
            ...
            MassBody::compute_point_mass_inertia(properties.mass, inertia_offset, offset_inertia);

            // Translate the input inertia to the CoM.
            Matrix3x3::subtract(inertia, offset_inertia, offset_inertia);

            // Transform to body.
            Matrix3x3::transform_matrix(orientation.trans, offset_inertia, properties.inertia);
            break;
        }
