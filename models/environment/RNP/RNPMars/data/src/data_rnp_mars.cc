...
void RNPMars_rnp_mars_default_data::initialize(RNPMars * RNPMars_ptr)
{
    ...
    RNPMars_ptr->NMars.I_m_orig = JEOD_ALLOC_PRIM_ARRAY(10, double); // from Konopliv 2006
    ...
    RNPMars_ptr->NMars.psi_m_orig = JEOD_ALLOC_PRIM_ARRAY(10, double); // from Konopliv 2006
    ...
    RNPMars_ptr->NMars.int_to_double = JEOD_ALLOC_PRIM_ARRAY(10, double);
