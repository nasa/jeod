/* Autogenerated from environment/atmosphere/data/solar_min.d */
...
void METAtmosphere_solar_min_default_data::initialize(METAtmosphere * METAtmosphere_ptr)
{
    /* Geomagnetic and solar activity parmeters. */
    METAtmosphere_ptr->geo_index_type = METAtmosphere::ATMOS_MET_GI_AP;
    METAtmosphere_ptr->geo_index = 0.0;
    METAtmosphere_ptr->F10 = 70.0;
    METAtmosphere_ptr->F10B = 70.0;
}
} // namespace jeod
