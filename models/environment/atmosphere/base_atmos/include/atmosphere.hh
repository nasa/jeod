...
/********************************* TRICK HEADER *******************************
PURPOSE:
   (Pure virtual class to inherit from when creating Atmosphere models.
    The parameters for calling the update_atmosphere function are defined.)

*******************************************************************************/

#ifndef JEOD_ATMOSPHERE_HH
#define JEOD_ATMOSPHERE_HH
