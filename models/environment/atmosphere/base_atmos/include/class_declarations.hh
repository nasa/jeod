 ...
 * @{
 *
 * @file models/environment/atmosphere/base_atmos/include/class_declarations.hh
 * Forward declarations of classes defined for JEOD 2.0 Atmosphere
 */

/*****************************************************************************
Purpose:
   (Provides a list of classes in this model)


   ()
*****************************************************************************/

#ifndef JEOD_ATMOSPHERE_CLASS_DECL_HH
