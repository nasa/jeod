...
def set_mass_iss(veh_obj_reference) :
  ...
  veh_obj_reference.mass_init.properties.mass              = trick.attach_units( "kg",400000.0)
  veh_obj_reference.mass_init.properties.position        = trick.attach_units( "m",[ -3.0, -1.5, 4.0])
  veh_obj_reference.mass_init.properties.inertia[0]  = trick.attach_units( "kg*m2",[  1.02e+8,-6.96e+6,-5.48e+6])
  veh_obj_reference.mass_init.properties.inertia[1]  = trick.attach_units( "kg*m2",[ -6.96e+6, 0.91e+8, 5.90e+5])
  veh_obj_reference.mass_init.properties.inertia[2]  = trick.attach_units( "kg*m2",[ -5.48e+6, 5.90e+5, 1.64e+8])
