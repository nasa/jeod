################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_state_iss_typical
####################################################################################
...
def set_state_iss_typical(veh_obj_reference) :
  ...
  veh_obj_reference.trans_init.position  = trick.attach_units( "m",[ -4292653.41, 955168.47, 5139356.57])
  veh_obj_reference.trans_init.velocity  = trick.attach_units( "m/s",[ 109.649663, -7527.726490, 1484.521489])
  ...
  veh_obj_reference.lvlh_init.ang_velocity            = trick.attach_units( "degree/s",[ 0.0, 0.0, 0.0])
