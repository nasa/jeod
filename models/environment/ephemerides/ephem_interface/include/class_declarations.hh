 ...
 * @{
 *
 * @file models/environment/ephemerides/ephem_interface/include/class_declarations.hh
 * Forward declarations of classes defined in
 * models/environment/ephemerides/ephem_interface files.
 */
