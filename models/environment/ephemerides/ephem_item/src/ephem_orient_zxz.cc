 ...
 * @return Euler angles
 */
const double * EphemerisZXZOrientation::get_euler_angles() const
{
 ...
 */
void EphemerisZXZOrientation::get_euler_angles(double * angles) const
{
 ...
 * @return Euler rates
 */
const double * EphemerisZXZOrientation::get_euler_rates() const
{
 ...
 */
void EphemerisZXZOrientation::get_euler_rates(double * rates) const
{
 ...
 */
void EphemerisZXZOrientation::propagate(double to_time)
{
 ...
 */
void EphemerisZXZOrientation::update(const double * angles, const double * derivs, double time)
{
    RefFrameRot * ref_state = &(target_frame->state.rot);
