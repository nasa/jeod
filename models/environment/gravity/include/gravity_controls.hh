...
class GravityControls {
 ...
 JEOD_MAKE_SIM_INTERFACES (GravityControls)
 ...
 private:
    ...
    * Not implemented.
    */
   GravityControls (const GravityControls &);

   /**
    * Not implemented.
    */
   GravityControls & operator= (const GravityControls &);
 ...
 public:
    ...
    */
   static bool accel_mag_less_ptr (
      const GravityControls* a,
      const GravityControls* b)
   {
