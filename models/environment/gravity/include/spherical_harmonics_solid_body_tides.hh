 ...
 * @{
 *
 * @file models/environment/gravity/include/spherical_harmonics_solid_body_tides.hh
 * Define the SphericalHarmonicsSolidBodyTides class, which models solid-body
 * tidal effects. SphericalHarmonicsSolidBodyTides inherits directly from the
 * SphericalHarmonicsTidalEffects class.
 */
