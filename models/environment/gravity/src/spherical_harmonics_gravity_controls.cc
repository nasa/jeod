 ...
 */
void
SphericalHarmonicsGravityControls::initialize_control (
 ...
 */
void
SphericalHarmonicsGravityControls::add_deltacontrol (
   SphericalHarmonicsDeltaControls * delta_control)
{
   ...
   if ((temp_deltacoeff->degree > delta_degree) ||
       (temp_deltacoeff->order > delta_order)) {
 ...
 */
unsigned int
SphericalHarmonicsGravityControls::get_degree (
   void)
{
   return degree;
}
 ...
 */
unsigned int
SphericalHarmonicsGravityControls::get_order (
   void)
{
   return order;
}
 ...
 */
void
SphericalHarmonicsGravityControls::get_degree_order (
 ...
 */
unsigned int
SphericalHarmonicsGravityControls::get_grad_degree (
   void)
{
 ...
 */
unsigned int
SphericalHarmonicsGravityControls::get_grad_order (
   void)
{
 ...
 */
void
SphericalHarmonicsGravityControls::get_grad_degree_order (
   unsigned int &curr_grad_degree,
 ...
 */
void
SphericalHarmonicsGravityControls::set_degree (
 ...
 */
void
SphericalHarmonicsGravityControls::set_order (
 ...
 */
void
SphericalHarmonicsGravityControls::set_degree_order (
   unsigned int new_degree,
   unsigned int new_order)
{
   degree = new_degree;
 ...
 */
void
SphericalHarmonicsGravityControls::set_grad_degree (
   unsigned int new_grad_degree)
{
 ...
 */
void
SphericalHarmonicsGravityControls::set_grad_order (
   unsigned int new_grad_order)
{
 ...
 */
void
SphericalHarmonicsGravityControls::set_grad_degree_order (
   unsigned int new_grad_degree,
   unsigned int new_grad_order)
{
   gradient_degree = new_grad_degree;
   ...
   void)
{
   ...
   if (! spherical) {
      ...
      if (degree > harmonics_source->degree) {
         MessageHandler::fail (
            __FILE__, __LINE__, GravityMessages::invalid_limit,
            "Gravity field degree requested(%i) for %s "
            "is greater than max gravity field degree(%i).",
            degree, harmonics_source->name.c_str(), harmonics_source->degree);
         return;
      }
      ...
      if (order > harmonics_source->order) {
         MessageHandler::fail (
            ...
            order, harmonics_source->name.c_str(), harmonics_source->order);
         return;
      }
      ...
      if (order > degree) {
         MessageHandler::fail (
            ...
            order, harmonics_source->name.c_str(), degree);
         return;
      }
      ...
      if (gradient) {
         ...
         if (gradient_degree > degree) {
            MessageHandler::fail (
               ...
               gradient_degree, harmonics_source->name.c_str(), degree);
         ...
         if (gradient_order > gradient_degree) {
            MessageHandler::error (
               ...
               gradient_order, harmonics_source->name.c_str(),
               gradient_degree);
         ...
         if (gradient_order > order) {
            MessageHandler::error (
               ...
               gradient_order, harmonics_source->name.c_str(), order);
 ...
 */
void
SphericalHarmonicsGravityControls::update_deltacoeffs (
   void)
{
 ...
 */
void
SphericalHarmonicsGravityControls::sum_deltacoeffs (
   void)
{
