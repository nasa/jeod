 ...
 */
void SphericalHarmonicsSolidBodyTides::initialize(SphericalHarmonicsDeltaCoeffsInit & var_init,
 ...
 */
void SphericalHarmonicsSolidBodyTides::update(SphericalHarmonicsGravityControls & controls JEOD_UNUSED)
{
    ...
    {
        tidal_bodies_inertial[ii]->compute_position_from(*pfix, pfix_position);
        ...
        F += tidal_body_mu / grav_source->mu * Rovr_3 * sqrt(5.0) * (1.5 * sin(phi) * sin(phi) - 0.5);
    }
