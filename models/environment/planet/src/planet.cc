 ...
 */
void Planet::register_model(GravitySource & grav_source_in, BaseDynManager & dyn_manager)
{
...
void Planet::initialize()
{
    ...
    if(name.empty())
    {
        MessageHandler::fail(__FILE__, __LINE__, PlanetMessages::name_error, "Planet object has a null or empty name.");
        return;
    }
    ...
    if(grav_source == nullptr)
    {
        MessageHandler::fail(__FILE__,
                             __LINE__,
                             PlanetMessages::registration_error,
