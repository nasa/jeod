################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_initplanet_eellip/
####################################################################################
...
#              where ellipsoid eccentricity is supplied parameter
#
#   
#*******************************************************************************/
...
## Test initialization from ellipsoid eccentricity
earth.planet.flat_inv = 0.0  # Zero out default value
earth.planet.e_ellipsoid =  0.081819221 # From Vallado 2nd ed., p. 908
