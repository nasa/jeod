################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_initplanet_eellipsq/
####################################################################################
...
#              where squared ellipsoid eccentricity is supplied parameter
#
#   
#*******************************************************************************/
...
## Test initialization from squared ellipsoid eccentricity
earth.planet.flat_inv = 0.0  # Zero out default value
earth.planet.e_ellip_sq =  0.006694384925 # From Vallado 2nd ed., p. 908
