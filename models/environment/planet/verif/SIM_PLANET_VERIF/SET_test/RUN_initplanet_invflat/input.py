################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_initplanet_invflat/
####################################################################################
...
#              where inverse flattening coefficient is supplied parameter
#
#   
#*******************************************************************************/
...
## Test initialization from inverse flattening coefficient
earth.planet.flat_inv = 0.0  # Zero out default value
earth.planet.flat_inv = 298.2570 # From Vallado 2nd ed., p. 908
