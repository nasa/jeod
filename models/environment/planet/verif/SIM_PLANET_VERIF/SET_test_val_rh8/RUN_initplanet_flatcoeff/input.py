################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_initplanet_flatcoeff/
####################################################################################
...
#              where flattening coefficient is supplied parameter
#
#   
#*******************************************************************************/
...
## Test initialization from flattening coefficient
earth.planet.flat_inv = 0.0  # Zero out default value
earth.planet.flat_coeff =  0.0033528131 # From Vallado 2nd ed., p. 908
