...
% File: spice.tex
%
% Purpose: Top level document for the SPICE model. Should not need to be edited.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand\documentHistory{
{\bf Author} & {\bf Date} & {\bf Description} \\ \hline \hline
\SpiceAuthor & \SpiceAuthDate & Initial Version \\ \hline
}
...
\hypersetup{
   pdftitle={\SpiceDesc},
   pdfauthor={\SpiceAuthor},
   pdfkeywords={\SpiceKeywords},
   pdfsubject={\SpiceDesc}}
...
%%% use of spiceChapters vs SpiceChapters is solely for the purpose of
%%% combatability with the copy_templates.csh script.
\include{spiceChapters}
