...
/**
 * SpiceEphemOrientation destructor.
 */
SpiceEphemOrientation::~SpiceEphemOrientation (
   void)
{
   ...
   double time_dyn)
{
   ...
   Matrix3x3::product_right_transpose (target_frame->state.rot.T_parent_this,
                                       t_dot, omega_b_wrt_a_in_b);
 ...
 */
void
SpiceEphemOrientation::validate (
   double time_tdb)
{
 ...
 */
void
SpiceEphemOrientation::get_spice_transformation (
   double time_tdb,
   double trans6x6[6][6])
{
