...
\input{timeIntro_change_history}
...
\input{timeSpec_Concept}
%\section{Mathematical Formulations}
\include{timeSpec_Math}
%\section{Detailed Design}
\include{timeSpec_Detailed}
...
\section{Analysis}
\input{timeUser_Analysis}

%\section{Integration}
\include{timeUser_Integration}

%\section{Extension}
\include{timeUser_Extension}
