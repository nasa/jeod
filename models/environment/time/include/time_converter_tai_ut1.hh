...
class TimeConverter_TAI_UT1 : public TimeConverter {
  ...
  JEOD_MAKE_SIM_INTERFACES(TimeConverter_TAI_UT1)
...
public:
 ...
 private:
  // initialize_tai_to_ut1 tables:
   void initialize_tai_to_ut1 (void);
 ...
 // declared private and are not implemented.
   TimeConverter_TAI_UT1 (const TimeConverter_TAI_UT1&);
   TimeConverter_TAI_UT1 & operator = (const TimeConverter_TAI_UT1&);
};
/*----------------------------------------------------------------------------*/
