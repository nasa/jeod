 ...
 */
void TimeConverter_STD_UDE::initialize(JeodBaseTime * parent_ptr, JeodBaseTime * child_ptr, const int int_dir)
{
 ...
 *     STD time only
 */
void TimeConverter_STD_UDE::convert_a_to_b()
{
 ...
 *     STD time only
 */
void TimeConverter_STD_UDE::convert_b_to_a()
{
 ...
 */
void TimeConverter_STD_UDE::reset_a_to_b_offset()
{
    a_to_b_offset = ude_ptr->seconds - std_ptr->seconds;
}
