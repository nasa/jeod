 ...
 */
void TimeConverter_TAI_UT1::initialize(JeodBaseTime * parent_ptr, JeodBaseTime * child_ptr, const int int_dir)
{
    ...
    else if(int_dir == -1)
    {
        ...
        if((tai_ptr->trunc_julian_time > next_when) || (tai_ptr->trunc_julian_time < prev_when))
        {
            initialize_tai_to_ut1();
        }
    }
 ...
 */
void TimeConverter_TAI_UT1::initialize_tai_to_ut1()
{
 ...
 *                TAI time only
 */
void TimeConverter_TAI_UT1::convert_a_to_b()
{
    /*  "when" is in days
 ...
 *                TAI time only
 */
void TimeConverter_TAI_UT1::convert_b_to_a()
{
 ...
 *  - None
 */
void TimeConverter_TAI_UT1::verify_table_lookup_ends()
{
    if(!ut1_ptr->true_ut1)
