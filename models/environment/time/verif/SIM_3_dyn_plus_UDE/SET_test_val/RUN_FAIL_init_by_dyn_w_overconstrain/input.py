################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_FAIL_init_by_dyn_w_overconstrain/ 
####################################################################################
...
jeod_time.time_ude.initial_value_format = trick.TimeEnum.seconds_since_epoch
jeod_time.time_ude.initializing_value = -5
