################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_9D/
####################################################################################
...
trick.add_read(10000,  """
sv_dyn.force_extern.force  = [ 10000.0, 0.0, 0.0]
sv_dyn.torque_extern.torque  = [ 10000.0, 0.0, 0.0]
""")

#/* Remove force and torque. */
trick.add_read(20000,  """
sv_dyn.force_extern.force  = [ 0.0, 0.0, 0.0]
sv_dyn.torque_extern.torque  = [ 0.0, 0.0, 0.0]
""")
...
#/* Apply a constant force and torque. */
trick.add_read(100000,  """
sv_dyn.force_extern.force  = [ 10000.0, 0.0, 0.0]
sv_dyn.torque_extern.torque  = [ 10000.0, 0.0, 0.0]
""")

#/* Remove force and torque. */
trick.add_read(110000,  """
sv_dyn.force_extern.force  = [ 0.0, 0.0, 0.0]
sv_dyn.torque_extern.torque  = [ 0.0, 0.0, 0.0]
""")
