################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_6A/
####################################################################################
...
exec(compile(open( "Modified_data/aero/const_density_drag.py", "rb").read(), "Modified_data/aero/const_density_drag.py", 'exec'))
set_aero_const_density_drag(sv_dyn)

#/* Configuration vehicle mass properties. */
exec(compile(open( "Modified_data/mass/sphere.py", "rb").read(), "Modified_data/mass/sphere.py", 'exec'))
set_mass_sphere(sv_dyn)
