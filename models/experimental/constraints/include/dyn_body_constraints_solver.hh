...
{
    JEOD_MAKE_SIM_INTERFACES(DynBodyConstraintsSolver)
...
public:
     ...
     */
    typedef JeodPointerVector<DynBodyConstraintsSolver>::type SolverVectorT;

    /**
     * Vector of pointers to DynBodyConstraint objects.
     */
    typedef JeodPointerVector<DynBodyConstraint>::type ConstraintsVectorT;
     ...
     */
    typedef JeodObjectVector<IndexPairT>::type IndexPairVectorT;
     ...
     */
    DynBodyConstraintsSolver (
        LinearSystemSolver& solver_,
        StructureIntegratedDynBody& dyn_body_);
     ...
     */
    SolverTypes::DecayedVector3T transform_direction_to_root (
     ...
     * @return root_point.
     */
    SolverTypes::DecayedVector3T transform_point_to_root (
...
private:
     ...
     */
    double root_to_this_transform[3][3]; //!< trick_units(--)
     ...
     */
    void build_system_of_equations (
        const VehicleProperties& vehicle_properties,
     ...
     */
    void compute_constraint_responses (
        const VehicleProperties& vehicle_properties,
        const VehicleNonGravState& non_grav_state);
...
private:
    ...
    DynBodyConstraintsSolver (const DynBodyConstraintsSolver&);
    DynBodyConstraintsSolver& operator= (const DynBodyConstraintsSolver&);
