...
{
    JEOD_MAKE_SIM_INTERFACES(TorqueConstraintComponent)
...
public:
    ...
    TorqueConstraintComponent& operator= (
        const TorqueConstraintComponent&) = default;
    TorqueConstraintComponent& operator= (
        TorqueConstraintComponent&&) = default;
