...
:
    ...
    constraint_wrench()
{
    Vector3::initialize (constraint_direction_constraint_frame);
    Vector3::initialize (constraint_direction_root);
    Vector3::initialize (constraint_omega_dot_root);
}


SolverTypes::ConstDecayedVector3T
ConstraintComponent::get_rotational_response (
    const VehicleProperties&) const
{
...
void
ConstraintComponent::set_constraint_direction (
...
void
ConstraintComponent::compute_root_direction ()
{
...
void
ConstraintComponent::compute_rotational_response (
    const VehicleProperties& vehicle_properties,
