...
void ConstraintFrame::set_struct_to_constraint_frame(SolverTypes::ConstDecayedMatrix3x3T transform_in,
...
void ConstraintFrame::update_root_to_constraint_frame()
{
    Matrix3x3::product(T_struct_constraint, solver->get_root_to_struct_transform(), T_root_constraint);

    Vector3::incr(solver->get_root_to_struct_offset(),
                  Vector3::transform_transpose(solver->get_root_to_struct_transform(),
