 ...
 */
void Contact::initialize_contact(DynManager * manager)
{
    ContactPair * pair;
    ...
    for(sub = contact_pairs.begin(); sub != contact_pairs.end(); ++sub)
    {
        if(!(*sub)->is_complete())
        {
            ...
            {
                if((*sub)->get_subject() != (*tar)->get_subject() &&
                   unique_pair((*sub)->get_subject(), (*tar)->get_subject()))
                {
 ...
 */
bool Contact::unique_pair(const ContactFacet * facet_1, const ContactFacet * facet_2)
{
    std::list<ContactPair *>::iterator cp;
 ...
 */
void Contact::register_contact(ContactFacet * facet)
{
    ContactPair * pair;
 ...
 */
void Contact::register_contact(ContactFacet ** facets, unsigned int nFacets)
{
 ...
 */
void Contact::register_contact(ContactFacet * facet1, ContactFacet * facet2)
{
    ContactPair * pair;
 ...
 */
void Contact::register_contact(ContactFacet ** facets1,
 ...
 */
void Contact::register_interaction(PairInteraction * interaction)
{
 ...
 */
PairInteraction * Contact::find_interaction(ContactParams * params_1, ContactParams * params_2)
{
    std::list<PairInteraction *>::iterator pint;
