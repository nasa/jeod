...
ContactSurface::~ContactSurface()
{
    JEOD_DELETE_2D(contact_facets, facets_size, false);
}
...
void ContactSurface::allocate_array(unsigned int size)
{
...
void ContactSurface::allocate_interaction_facet(Facet * facet,
                                                ...
                                                unsigned int index)
{
    ...
    auto * temp_contact_facet = dynamic_cast<ContactFacet *>(temp_facet);
...
void ContactSurface::collect_forces_torques()
{
