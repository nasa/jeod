...
InteractionFacet * LineContactFacetFactory::create_facet(Facet * facet, FacetParams * params)
{
    ...
    LineContactFacet * inter_facet = JEOD_ALLOC_CLASS_OBJECT(LineContactFacet, ());
...
bool LineContactFacetFactory::is_correct_factory(Facet * facet)
{
