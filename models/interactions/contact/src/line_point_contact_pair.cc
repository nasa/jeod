 ...
 */
void LinePointContactPair::in_contact()
{
    ...
    ContactUtils::dist_line_segments(sub_p1,
                                     sub_p2,
                                     rel_state.rel_state.trans.position,
                                     rel_state.rel_state.trans.position,
                                     subject_contact_point,
 ...
 */
void LinePointContactPair::initialize_pair(ContactFacet * subject_facet, ContactFacet * target_facet)
{
    ...
    if(target_facet != nullptr)
    {
        ...
        rel_state.name = NamedItem::construct_name(line_subject->base_facet->name, point_target->base_facet->name);
