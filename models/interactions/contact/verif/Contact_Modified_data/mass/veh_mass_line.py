...
def set_mass_veh_mass(sv_dyn_reference) :
  #// Initialization data for vehicle mass properties
  #// In this case, we model a 1m radius 2m long, 200kg solid cylinder.
  ...
  sv_dyn_reference.mass_init.properties.mass              = 200.0
  ...
  sv_dyn_reference.mass_init.properties.inertia[0]  = [ 100.0,    0.0,      0.0]
  sv_dyn_reference.mass_init.properties.inertia[1]  = [   0.0,  116.6667,   0.0]
  sv_dyn_reference.mass_init.properties.inertia[2]  = [   0.0,    0.0,    116.6667]
