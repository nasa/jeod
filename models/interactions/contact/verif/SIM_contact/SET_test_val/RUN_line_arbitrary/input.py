...
veh1_dyn.rot_init.orientation.euler_angles  = trick.attach_units( "degree",[ 0.0,   45.0,   0.0])
...
veh2_dyn.rot_init.orientation.euler_angles  = trick.attach_units( "degree",[ 0.0,   0.0,   45.0])
