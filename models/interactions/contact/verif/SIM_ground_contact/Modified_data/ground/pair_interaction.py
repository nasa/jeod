...
def set_contact_interaction(contact_reference) :
  ...
  pair_interaction_local.params_2 = "dirt"

  pair_interaction_local.spring_k = trick.attach_units( "lbf/in",10.0)
  pair_interaction_local.damping_b = trick.attach_units( "lbf*s/in",0.2)
  pair_interaction_local.mu = 0.5
