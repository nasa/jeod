...
*******************************************************************************/
void ContactGround::check_contact_ground()
{
    if(ground_active)
    {
        std::list<GroundInteraction *>::iterator gi;
 ...
 *******************************************************************************/
GroundInteraction * ContactGround::get_ground_interaction(/* Return: -- ground interaction */
                                                          ContactFacet * facet)
{
    std::list<GroundInteraction *>::iterator gi;
 ...
 *******************************************************************************/
bool ContactGround::is_unique_ground_interaction(/* Return: -- bool */
                                                 ContactFacet * facet)
{
    std::list<GroundInteraction *>::iterator gi;
 ...
 *******************************************************************************/
void ContactGround::initialize_ground(                      /* Return: -- Void */
...
/*******************************************************************************
 ...
 Class: (initialization)
 *******************************************************************************/
void ContactGround::register_ground_facet(                            /* Return: -- Void */
