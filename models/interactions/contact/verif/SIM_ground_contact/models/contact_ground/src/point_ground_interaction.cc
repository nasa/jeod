 ...
 *******************************************************************************/
void PointGroundInteraction::in_contact()
{
    ...
    Vector3::transform(subject_point->vehicle_point->state.rot.T_parent_this, vec, ground_point);
    ...
    if(subject_mag < ground_mag)
    {
        ...
        Vector3::cross(subject_point->vehicle_point->state.rot.ang_vel_this,
                       ...
                       rel_velocity);
        Vector3::transform(subject_point->vehicle_point->state.rot.T_parent_this,
                           subject_point->vehicle_point->state.trans.velocity,
                           nvec);
