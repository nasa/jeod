 ...
 * @{
 *
 * @file models/utils/container/include/object_list.hh
...
#ifndef JEOD_MEMORY_OBJECT_LIST_HH
#define JEOD_MEMORY_OBJECT_LIST_HH
...
public:
    ...
    */
   typedef JeodObjectContainer<JeodList<ElemType>, ElemType> type;
};
