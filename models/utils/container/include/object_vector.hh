 ...
 * @{
 *
 * @file models/utils/container/include/object_vector.hh
...
#ifndef JEOD_MEMORY_OBJECT_VECTOR_HH
#define JEOD_MEMORY_OBJECT_VECTOR_HH
...
public:
    ...
    */
   typedef JeodObjectContainer<JeodVector<ElemType>, ElemType> type;
};
