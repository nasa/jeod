 ...
 * @{
 *
 * @file models/utils/container/include/pointer_list.hh
...
#ifndef JEOD_MEMORY_POINTER_LIST_HH
#define JEOD_MEMORY_POINTER_LIST_HH
...
public:
    ...
    */
   typedef JeodPointerContainer<JeodList<ElemType*>, ElemType> type;
};
