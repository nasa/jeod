 ...
 * @{
 *
 * @file models/utils/container/include/pointer_set.hh
...
#ifndef JEOD_MEMORY_POINTER_SET_HH
#define JEOD_MEMORY_POINTER_SET_HH
...
public:
    ...
    */
   typedef JeodPointerContainer<JeodSet<ElemType*>, ElemType> type;
};
