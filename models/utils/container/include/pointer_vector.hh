 ...
 * @{
 *
 * @file models/utils/container/include/pointer_vector.hh
...
#ifndef JEOD_MEMORY_POINTER_VECTOR_HH
#define JEOD_MEMORY_POINTER_VECTOR_HH
...
public:
    ...
    */
   typedef JeodPointerContainer<JeodVector<ElemType*>, ElemType> type;
};
