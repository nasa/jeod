 ...
 * @{
 *
 * @file models/utils/container/include/primitive_list.hh
...
#ifndef JEOD_MEMORY_PRIMITIVE_LIST_HH
#define JEOD_MEMORY_PRIMITIVE_LIST_HH
...
public:
    ...
    */
   typedef JeodPrimitiveContainer<JeodList<ElemType>, ElemType> type;
};
