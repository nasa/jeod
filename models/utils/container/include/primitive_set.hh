 ...
 * @{
 *
 * @file models/utils/container/include/primitive_set.hh
...
#ifndef JEOD_MEMORY_PRIMITIVE_SET_HH
#define JEOD_MEMORY_PRIMITIVE_SET_HH
...
public:
    ...
    */
   typedef JeodPrimitiveContainer<JeodSet<ElemType>, ElemType> type;
};
