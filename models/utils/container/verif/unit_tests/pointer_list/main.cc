...
void
print_foo_list (
   const std::list<Foo*> list) {
   std::cout << "Start\n";
   for (std::list<Foo*>::const_iterator it = list.begin();
        it != list.end();
        ++it) {
      Foo * foo = *it;
      std::cout << " " << foo->bar << "\n";
...
void
compare_foo_list (
   const std::string & name1, const Type1 & arg1,
   const std::string & name2, const Type2 & arg2)
{
...
int main ()
{
   ...
   compare_foo_list ("jeod_foo_pointer_list", jeod_foo_pointer_list,
                     "stl_foo_pointer_list", stl_foo_pointer_list);
   compare_foo_list ("jeod_foo_pointer_list", jeod_foo_pointer_list,
                     "another_foo_pointer_list", another_foo_pointer_list);
   ...
   compare_foo_list ("jeod_foo_pointer_list", jeod_foo_pointer_list,
                     "another_foo_pointer_list", another_foo_pointer_list);
   compare_foo_list ("stl_foo_pointer_list", stl_foo_pointer_list,
                     "another_foo_pointer_list", another_foo_pointer_list);
