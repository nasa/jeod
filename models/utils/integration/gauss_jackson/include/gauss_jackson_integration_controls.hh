...
JEOD_MAKE_SIM_INTERFACES(GaussJacksonIntegrationControls)
...
public:
    ...
    * @param  src  Object to be copied.
    */
   GaussJacksonIntegrationControls & operator= (
      GaussJacksonIntegrationControls src)
   {
      swap (src);
      return *this;
   }
