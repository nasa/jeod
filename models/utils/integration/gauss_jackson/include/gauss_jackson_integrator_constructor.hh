 ...
 */
class GaussJacksonIntegratorConstructor : public er7_utils::IntegratorConstructor
{
    JEOD_MAKE_SIM_INTERFACES(jeod, GaussJacksonIntegratorConstructor)
...
public:
     ...
     */
    GaussJacksonIntegratorConstructor() = default;

    /**
     * GaussJacksonIntegratorConstructor copy constructor.
     */
    GaussJacksonIntegratorConstructor(const GaussJacksonIntegratorConstructor & src);
     ...
     */
    GaussJacksonIntegratorConstructor & operator=(GaussJacksonIntegratorConstructor src)
    {
        swap(src);
        return *this;
    }
     ...
     */
    void configure(const GaussJacksonConfig & config_in,
                   er7_utils::Integration::Technique priming_technique = er7_utils::Integration::Unspecified);

    /**
     * Configure the Gauss-Jackson integrator constructor.
     */
    void configure(const GaussJacksonConfig & config_in, const er7_utils::IntegratorConstructor & priming_cotr_in);
    ...
    {
        return (problem_type != er7_utils::Integration::GeneralizedStepSecondOrderODE);
    }
     ...
     */
    unsigned int get_buffer_size() const override
    {
        return 192;
    }
