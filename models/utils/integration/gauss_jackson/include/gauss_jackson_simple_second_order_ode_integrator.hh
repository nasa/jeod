 ...
 */
class GaussJacksonSimpleSecondOrderODEIntegrator :
   public er7_utils::SecondOrderODEIntegrator,
   public GaussJacksonIntegratorBaseSecond {  // changed from private to public to fixed "cannot access private member error when move into namespace"
JEOD_MAKE_SIM_INTERFACES(GaussJacksonSimpleSecondOrderODEIntegrator)
...
public:
    ...
    */
   GaussJacksonSimpleSecondOrderODEIntegrator (
      const GaussJacksonSimpleSecondOrderODEIntegrator & src)
   :
      er7_utils::Er7UtilsDeletable (),
    ...
    * @param  src  Item to be copied.
    */
   GaussJacksonSimpleSecondOrderODEIntegrator & operator= (
      GaussJacksonSimpleSecondOrderODEIntegrator src)
   {
      swap (src);
      return *this;
   }
    ...
    */
   void swap (
      GaussJacksonSimpleSecondOrderODEIntegrator & other)
   {
