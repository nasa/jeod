...
void
GaussJacksonCoefficientsPair::allocate_arrays (
   int size)
{
...
void
GaussJacksonCoefficientsPair::deallocate_arrays ()
{
...
void
GaussJacksonCoefficientsPair::swap (
   GaussJacksonCoefficientsPair & other)
{
...
void
GaussJacksonCoefficientsPair::apply (
   int nelem,
   int ncoeff,
...
void
GaussJacksonCoefficientsPair::print (
   int order,
   std::ostream & stream)
const
{
