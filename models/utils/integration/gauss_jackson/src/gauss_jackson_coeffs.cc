...
// Swap.
void GaussJacksonCoeffs::swap(GaussJacksonCoeffs & src)
{
...
void GaussJacksonCoeffs::configure(unsigned int max_order_in)
{
    ...
    er7_utils::alloc::deallocate_array(corrector);
    corrector = er7_utils::alloc::allocate_array<GaussJacksonCoefficientsPair>(max_order + 1);
...
void GaussJacksonCoeffs::compute_coeffs(unsigned int order_in)
{
    ...
    GaussJacksonRationalCoefficients sc = ac.construct_stormer_cowell_corrector();
