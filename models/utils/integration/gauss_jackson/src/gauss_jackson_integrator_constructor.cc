 ...
 */
static GaussJacksonIntegrationControls * cast_to_gj_controls(er7_utils::IntegrationControls & controls)
{
    auto * gj_controls = dynamic_cast<GaussJacksonIntegrationControls *>(&controls);
...
er7_utils::IntegratorConstructor * GaussJacksonIntegratorConstructor::create_constructor()
{
    return er7_utils::alloc::allocate_object<GaussJacksonIntegratorConstructor>();
}

// Copy constructor.
GaussJacksonIntegratorConstructor::GaussJacksonIntegratorConstructor(const GaussJacksonIntegratorConstructor & src)
...
// Non-throwing swap.
void GaussJacksonIntegratorConstructor::swap(GaussJacksonIntegratorConstructor & src)
{
...
// Configure.
void GaussJacksonIntegratorConstructor::configure(const GaussJacksonConfig & config_in,
                                                  er7_utils::Integration::Technique priming_technique)
{
    ...
    priming_constructor = er7_utils::IntegratorConstructorFactory::create(config.priming_technique);
}
...
er7_utils::IntegratorConstructor * GaussJacksonIntegratorConstructor::create_copy() const
{
    return er7_utils::alloc::replicate_object(*this);
}

// Create an GaussJackson integration controls.
er7_utils::IntegrationControls * GaussJacksonIntegratorConstructor::create_integration_controls() const
{
    // Configure this object with the standard config if not already configured.
    if(priming_constructor == nullptr)
    {
        (const_cast<GaussJacksonIntegratorConstructor *>(this))
            ->configure(GaussJacksonConfig::standard_configuration());
    }

    return er7_utils::alloc::allocate_object<GaussJacksonIntegrationControls,
                                             const er7_utils::IntegratorConstructor &,
                                             const GaussJacksonConfig &>(*priming_constructor, config);
}

// Create an GaussJackson state integrator for a first order ODE.
er7_utils::FirstOrderODEIntegrator * GaussJacksonIntegratorConstructor::create_first_order_ode_integrator(
    unsigned int size, er7_utils::IntegrationControls & controls) const
{
    GaussJacksonIntegrationControls * gj_controls = cast_to_gj_controls(controls);

    return er7_utils::alloc::allocate_object<GaussJacksonFirstOrderODEIntegrator,
                                             const er7_utils::IntegratorConstructor &,
                                             GaussJacksonIntegrationControls &,
                                             unsigned int,
                                             er7_utils::IntegrationControls &>(*priming_constructor,
                                                                               *gj_controls,
                                                                               size,
...
er7_utils::SecondOrderODEIntegrator * GaussJacksonIntegratorConstructor::create_second_order_ode_integrator(
    unsigned int size, er7_utils::IntegrationControls & controls) const
{
    GaussJacksonIntegrationControls * gj_controls = cast_to_gj_controls(controls);

    return er7_utils::alloc::allocate_object<GaussJacksonSimpleSecondOrderODEIntegrator,
                                             const er7_utils::IntegratorConstructor &,
                                             GaussJacksonIntegrationControls &,
                                             unsigned int,
                                             er7_utils::IntegrationControls &>(*priming_constructor,
...
GaussJacksonIntegratorConstructor::create_generalized_deriv_second_order_ode_integrator(
    ...
    er7_utils::IntegrationControls & controls) const
{
    ...
    return er7_utils::alloc::allocate_object<GaussJacksonGeneralizedDerivSecondOrderODEIntegrator,
                                             const er7_utils::IntegratorConstructor &,
                                             GaussJacksonIntegrationControls &,
                                             unsigned int,
                                             unsigned int,
