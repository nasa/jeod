...
void GaussJacksonRationalCoefficients::configure_adams_corrector(unsigned int nelem)
{
...
GaussJacksonRationalCoefficients GaussJacksonRationalCoefficients::construct_stormer_cowell_corrector() const
{
...
GaussJacksonRationalCoefficients GaussJacksonRationalCoefficients::construct_predictor() const
{
    // Create a set of unpopulated rational coefficients sized the same as this.
    GaussJacksonRationalCoefficients result;
    unsigned int nelem = coefficients.size();
...
void GaussJacksonRationalCoefficients::convert_to_ordinate_form(er7_utils::NChooseM & n_choose_m, double * result) const
{
    // Create a set of unpopulated rational coefficients sized the same as this.
...
void GaussJacksonRationalCoefficients::discard_extra_terms(unsigned int nfront, unsigned int nback)
{
...
// Note: This assumes that the correct number of leading terms have been
// discarded from the front of the coefficients vector.
void GaussJacksonRationalCoefficients::displace_back()
{
    // Create a set of unpopulated rational coefficients sized the same as this.
