...
class RestartableStateIntegrator : public SimpleCheckpointable {
...
public:
      ...
      er7_utils::IntegrationControls & controls)
   {
      ...
      // This is a no-op if *integrator_handle is null.
      destroy_integrator ();
    ...
    */
   void set_integrator_reference (
      IntegratorType *& integ_ptr)
   {
...
protected:
    ...
    *                           is to be managed.
    */
   explicit RestartableStateIntegrator (
      IntegratorType *& integ_ref)
   :
      SimpleCheckpointable(),
...
private:
    ...
    */
   virtual IntegratorType * create_integrator_internal (
      const er7_utils::IntegratorConstructor & generator,
   ...
   virtual void simple_restore_internal (
      IntegratorType * integrator_ptr JEOD_UNUSED)
   { }
    ...
    * Not implemented.
    */
   RestartableStateIntegrator (const RestartableStateIntegrator &);

   /**
    * Not implemented.
    */
   RestartableStateIntegrator & operator= (const RestartableStateIntegrator &);
};
...
class RestartableFirstOrderODEIntegrator :
   public RestartableStateIntegrator<er7_utils::FirstOrderODEIntegrator> {
...
public:
   ...
   : RestartableStateIntegrator<er7_utils::FirstOrderODEIntegrator>()
   { }
    ...
    *                           is to be managed.
    */
   explicit RestartableFirstOrderODEIntegrator (
      er7_utils::FirstOrderODEIntegrator *& integ_ref)
...
private:
    ...
    */
   RestartableFirstOrderODEIntegrator (
      const RestartableFirstOrderODEIntegrator &);

   /**
    * Not implemented.
    */
   RestartableFirstOrderODEIntegrator & operator= (
      const RestartableFirstOrderODEIntegrator &);
};
 ...
 * order ODE problem.
 */
class RestartableSecondOrderODEIntegrator :
   public RestartableStateIntegrator<er7_utils::SecondOrderODEIntegrator> {
...
protected:
   ...
   : RestartableStateIntegrator<er7_utils::SecondOrderODEIntegrator> ()
   { }
    ...
    *                           is to be managed.
    */
   explicit RestartableSecondOrderODEIntegrator (
      er7_utils::SecondOrderODEIntegrator *& integ_ref)
...
private:
    ...
    */
   RestartableSecondOrderODEIntegrator (
      const RestartableSecondOrderODEIntegrator &);

   /**
    * Not implemented.
    */
   RestartableSecondOrderODEIntegrator & operator= (
      const RestartableSecondOrderODEIntegrator &);
};
 ...
 */
template <unsigned int size>
class RestartableSimpleSecondOrderODEIntegrator :
   public RestartableSecondOrderODEIntegrator {
...
public:
    ...
    *                           is to be managed.
    */
   explicit RestartableSimpleSecondOrderODEIntegrator (
      er7_utils::SecondOrderODEIntegrator *& integ_ref)
...
private:
    ...
    */
   RestartableSimpleSecondOrderODEIntegrator (
      const RestartableSimpleSecondOrderODEIntegrator &);

   /**
    * Not implemented.
    */
   RestartableSimpleSecondOrderODEIntegrator & operator= (
      const RestartableSimpleSecondOrderODEIntegrator &);
};
 ...
 */
template <unsigned int position_size,
          unsigned int velocity_size,
          typename DerivFunctions>
class RestartableGeneralizedDerivSecondOrderODEIntegrator :
   public RestartableSecondOrderODEIntegrator {
...
public:
    ...
    *                           is to be managed.
    */
   explicit RestartableGeneralizedDerivSecondOrderODEIntegrator (
      er7_utils::SecondOrderODEIntegrator *& integ_ref)
   : RestartableSecondOrderODEIntegrator (integ_ref)
   { }
...
private:
    ...
    */
   RestartableGeneralizedDerivSecondOrderODEIntegrator (
      const RestartableGeneralizedDerivSecondOrderODEIntegrator &);
...
template <unsigned int position_size,
          unsigned int velocity_size,
          typename StepFunctions>
class RestartableGeneralizedStepSecondOrderODEIntegrator :
   public RestartableSecondOrderODEIntegrator {
...
public:
    ...
    *                           is to be managed.
    */
   explicit RestartableGeneralizedStepSecondOrderODEIntegrator (
      er7_utils::SecondOrderODEIntegrator *& integ_ref)
   : RestartableSecondOrderODEIntegrator (integ_ref)
   { }
...
private:
    ...
    */
   RestartableGeneralizedStepSecondOrderODEIntegrator (
      const RestartableGeneralizedStepSecondOrderODEIntegrator &);
