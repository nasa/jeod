 ...
 * @{
 *
 * @file models/utils/integration/include/time_change_subscriber.hh
 * Define the class TimeChangeSubscriber.
 */
...
#ifndef JEOD_TIME_CHANGE_SUBSCRIBER_HH
#define JEOD_TIME_CHANGE_SUBSCRIBER_HH
