...
Constructors
******************************************************************************/
LsodeIntegrationControls::LsodeIntegrationControls(unsigned int num_stages JEOD_UNUSED) {}

/*****************************************************************************
create_copy
******************************************************************************/
LsodeIntegrationControls * LsodeIntegrationControls::create_copy() const
{
 ...
 */
unsigned int LsodeIntegrationControls::integrate(double starttime,
                                                 double sim_dt,
                                                 ...
                                                 er7_utils::BaseIntegrationGroup & integ_group)
{
    ...
    const er7_utils::IntegratorResult & integ_status = integ_group.integrate_bodies(integ_dyndt, 1);
