...
er7_utils::IntegratorConstructor*
LsodeIntegratorConstructor::create_constructor(void)
{
...
er7_utils::IntegratorConstructor *
LsodeIntegratorConstructor::create_copy (
   void)
const
{
...
LsodeIntegratorConstructor::create_integration_controls (
   void)
const
{
...
LsodeIntegratorConstructor::create_first_order_ode_integrator (
   unsigned int size,
...
LsodeIntegratorConstructor::create_second_order_ode_integrator (
   unsigned int size,
   er7_utils::IntegrationControls & controls)
const
{
...
const
{
   LsodeControlDataInterface & non_const_data_interface =
      const_cast<LsodeControlDataInterface&> (data_interface);
