...
LsodeSimpleSecondOrderODEIntegrator::LsodeSimpleSecondOrderODEIntegrator(const LsodeControlDataInterface & data_in,
...
LsodeSimpleSecondOrderODEIntegrator * LsodeSimpleSecondOrderODEIntegrator::create_copy() const
{
...
er7_utils::IntegratorResult LsodeSimpleSecondOrderODEIntegrator::integrate(double dyn_dt,
                                                                           ...
                                                                           double * ER7_UTILS_RESTRICT position)
{
    ...
    return_val = first_order_integrator.integrate(dyn_dt, 1, y_dot, y);
    for(unsigned int ii = 0; ii < zeroth_derivative_size; ii++)
    {
        position[ii] = y[ii];
