...
bool GeneralizedSecondOrderODETechnique::is_provided_by(const er7_utils::IntegratorConstructor & generator,
                                                        TechniqueType technique)
{
    switch(technique)
    {
        case Cartesian:
            return generator.provides(er7_utils::Integration::GeneralizedDerivSecondOrderODE);

        case LieGroup:
            return generator.provides(er7_utils::Integration::GeneralizedStepSecondOrderODE);
...
GeneralizedSecondOrderODETechnique::TechniqueType GeneralizedSecondOrderODETechnique::validate_technique(
