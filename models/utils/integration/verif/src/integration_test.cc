...
:
   ...
   Q_bcanon_binteg()
{
   Matrix3x3::identity (T_iinteg_icanon);
   Matrix3x3::identity (T_bcanon_binteg);
}
...
*/
IntegrationTest::IntegrationTest (
   const IntegrationTest & source,
   unsigned int test_incr)
:
...
Purpose: (Destructor.)
*/
IntegrationTest::~IntegrationTest ( // Return: N/A (destructor)
   void)
{
...
*/
double
IntegrationTest::get_time_scale (  // Return: s Time scale
   void)
const
{
   return time_scale;
...
*/
const std::type_info &
IntegrationTest::integrator_id (   // Return: -- State integrator ID
   void)
const
{
...
IntegrationTest::configure (
   bool randomize,              // In: -- Use a random orientation?
...
*/
void
IntegrationTest::initialize (   // Return: -- Void
...
*/
void
IntegrationTest::pre_initialize (   // Return: -- Void
   void)
{
...
*/
void
IntegrationTest::post_initialize (  // Return: -- Void
   void)
{
   // Empty for now.
}
...
*/
void
IntegrationTest::shutdown (        // Return: -- Void
