 ...
 * @{
 *
 * @file models/utils/lvlh_frame/include/lvlh_frame_messages.hh
 * Define the class LvlhFrameMessages, the class that specifies the message
 * IDs used in the LvlhFrame model.
 */
...
Assumptions and limitations:
  ((This is a complete catalog of all messages sent by the LvlhFrame model.)
