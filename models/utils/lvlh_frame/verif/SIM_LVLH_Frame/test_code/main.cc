...
int main(int arg_c, char ** arg_v)
{
    ...
    auto ** computedLvlhPos = new double *[numRows];
    auto ** computedLvlhVel = new double *[numRows];
    auto ** computedLvlhAngVel = new double *[numRows];
    auto *** computedLvlhOrient = new double **[numRows];
    auto ** computedLvlhQuat = new jeod::Quaternion *[numRows];
    ...
    for(int ii = 0; ii < numRows; ++ii)
    {
        ...
        std::cout << "Calculated: " << computedLvlhAngVel[ii][0] << ", " << computedLvlhAngVel[ii][1] << ", "
                  << computedLvlhAngVel[ii][2] << std::endl;
    }
    ...
    for(int ii = 0; ii < numRows; ++ii)
    {
        ...
        for(int jj = 0; jj < 3; ++jj)
        {
            delete[] computedLvlhOrient[ii][jj];
        }
        delete[] computedLvlhOrient[ii];
    }
