...
class Matrix3x3 {
 ...
 public:
   ...
   static void outer_product (
      double const vec_left[3], double const vec_right[3], double prod[3][3]);
   ...
   static void add (
      double const augend[3][3], double const addend[3][3], double sum[3][3]);
   ...
   // Assumption: Matrices are distinct
   static void product_left_transpose (
      double const mat_left[3][3],
      double const mat_right[3][3],
      double prod[3][3]);
   ...
   // Assumption: Matrices are distinct
   static void product_right_transpose (
      double const mat_left[3][3],
      double const mat_right[3][3],
      double prod[3][3]);
   ...
   // Assumption: Matrices are distinct
   static void product_transpose_transpose (
      double const mat_left[3][3],
      double const mat_right[3][3],
      double prod[3][3]);
   ...
   static void transform_matrix (
      double const trans[3][3], double const mat[3][3], double prod[3][3]);

   // Compute matrix product trans^T * mat * trans
   // prod[i][j] = trans[k][i] * mat[k][l] * trans[l][j]
   // Assumption: Matrices are distinct
   static void transpose_transform_matrix (
      double const trans[3][3], double const mat[3][3], double prod[3][3]);
   ...
   static int invert_symmetric (
      double const matrix[3][3], double inverse[3][3]);
