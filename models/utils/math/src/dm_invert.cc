   ...
   double inverse[3][3])
{
   ...
   inverse[0][1] *= det_inv;
   inverse[0][2] *= det_inv;
   inverse[1][0]  = (matrix[2][0] * matrix[1][2] -
                     matrix[1][0] * matrix[2][2]) * det_inv;
   ...
   inverse[2][0]  = (matrix[1][0] * matrix[2][1] -
                     matrix[2][0] * matrix[1][1]) * det_inv;
   inverse[2][1]  = (matrix[2][0] * matrix[0][1] -
                     matrix[0][0] * matrix[2][1]) * det_inv;
