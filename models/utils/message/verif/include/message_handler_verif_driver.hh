...
Purpose:
  (Define the class MessageHandlerVerifDriver, the class that generates
...
// Define JEOD_TRICK_INTEGRATOR_ALIAS based on Trick version
// This is intentionally a different name than the one used
// in the TrickIntegrator interface class.
