...
*******************************************************************************/
int MessageHandlerVerifDriver::integrate(                        // Return: -- Zero
...
*******************************************************************************/
void MessageHandlerVerifDriver::generate_messages() // Return: N/A
{
    switch(message_number)
    {
        ...
        case 1:
            MessageHandler::fail(__FILE__,
                                 __LINE__,
                                 MessageHandlerVerifMessages::error,
                                 "Test of %s",
                                 "MessageHandler::fail()");
            break;
        ...
        case 3:
            MessageHandler::warn(__FILE__,
                                 __LINE__,
                                 MessageHandlerVerifMessages::warning,
                                 "Test of %s",
                                 "MessageHandler::warn()");
            break;
        ...
        case 4:
            MessageHandler::inform(__FILE__,
                                   __LINE__,
                                   MessageHandlerVerifMessages::inform,
                                   "Test of %s",
        ...
        case 5:
            MessageHandler::debug(__FILE__,
                                  __LINE__,
                                  MessageHandlerVerifMessages::debug,
                                  "Test of %s",
                                  "MessageHandler::debug()");
            break;

        case 6:
            MessageHandler::send_message(6,
                                         "Message",
                                         __FILE__,
                                         __LINE__,
                                         MessageHandlerVerifMessages::message,
                                         "Test of %s",
