 ...
 * @{
 *
 * @file models/utils/model_template/include/foo.hh
 * The file header purpose should describe why the file exists,
 * briefly summarizing the contents of the file.
 * In this case, the purpose is to define the class Foo.
 */
...
#define JEOD_MODEL_TEMPLATE_FOO_HH
 ...
 * class. Explain why the class exists, what it does.
