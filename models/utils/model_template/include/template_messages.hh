 ...
 * @{
 *
 * @file models/utils/model_template/include/template_messages.hh
 * Define the class TemplateMessages, the class that specifies the
 * message IDs used in the model template model.
 */
