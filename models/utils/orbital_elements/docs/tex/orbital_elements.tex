...
\hypersetup{
   pdftitle={\OrbitalElementDesc},
   pdfauthor={\ModelAuthor},
   pdfkeywords={\ModelKeywords},
   pdfsubject={\OrbitalElementDesc}}
...
\docid{models/utils/orbital\_elements}
\docrev{1.0}
\date{\RELEASEMONTH\ \RELEASEYEAR}
\modelname{\OrbitalElementDesc}
\doctype{}
\author{\ModelAuthor}
\managers{
...
\include{OrbitalElementAbstract}
...
%%% use of OrbitalElementChapters vs ModelChapters is solely for the purpose of
%%% combatability with the copy_templates.csh script.
\include{OrbitalElementChapters}
...
%\include{OrbitalElementChapters1}
%\hyperdef{part}{part2}{\part{Part 2 Title}}\label{pt2:title}
%\include{OrbitalElementChapters2}
%%% etc.
...
\bibliography{dynenv,OrbitalElement}
