################TRICK HEADER#######################################
#PURPOSE:
#  (To define the method set_default_mods_multi
####################################################################################
...
exec(compile(open("Log_data/log_orb_elem_multi_rec.py", "rb").read(), "Log_data/log_orb_elem_multi_rec.py", 'exec'))

def set_default_mods_multi(orb_elem_test) :

  set_default_data(orb_elem_test)

  # Trick 7 version was hard coded in the logfile as 0.1 seconds
  log_orb_elem_multi_rec(0.1)
