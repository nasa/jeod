################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_T37_OE_VER/
####################################################################################
...
orb_elem_test.orb_elem.inclination   = 3.141592653589793
...
orb_elem_test.orb_elem.arg_periapsis = 3.141592653589794
orb_elem_test.orb_elem.long_asc_node = 0.0
orb_elem_test.orb_elem_ver.to_cartesian = True
""")
