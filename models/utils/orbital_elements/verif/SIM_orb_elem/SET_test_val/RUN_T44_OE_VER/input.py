################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_T44_OE_VER/ 
####################################################################################
...
exec(compile(open( "Modified_data/orb_par_trans_in.py", "rb").read(), "Modified_data/orb_par_trans_in.py", 'exec'))
set_orb_par_trans_in(orb_elem_test)
