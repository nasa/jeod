################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_T45_OE_VER/
####################################################################################
...
exec(compile(open( "Modified_data/orb_par_tot_in.py", "rb").read(), "Modified_data/orb_par_tot_in.py", 'exec'))
set_orb_par_tot_in(orb_elem_test)
