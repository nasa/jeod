################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_T48_OE_VER/
####################################################################################
...
exec(compile(open( "Modified_data/orb_hyp_1p6_HM_in.py", "rb").read(), "Modified_data/orb_hyp_1p6_HM_in.py", 'exec'))
set_orb_hyp_1p6_HM_in(orb_elem_test)
