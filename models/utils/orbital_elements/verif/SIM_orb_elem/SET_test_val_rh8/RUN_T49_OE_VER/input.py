################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_T49_OE_VER/ 
####################################################################################
...
exec(compile(open( "Modified_data/orb_hyp_2p5_HM_in.py", "rb").read(), "Modified_data/orb_hyp_2p5_HM_in.py", 'exec'))
set_orb_hyp_2p5_HM_in(orb_elem_test)
