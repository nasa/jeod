################TRICK HEADER#######################################
#PURPOSE:
#  (To define the input data for simulation SET_test/RUN_T50_OE_VER/
####################################################################################
...
exec(compile(open( "Modified_data/orb_hyp_3p9_HM_in.py", "rb").read(), "Modified_data/orb_hyp_3p9_HM_in.py", 'exec'))
set_orb_hyp_3p9_HM_in(orb_elem_test)
