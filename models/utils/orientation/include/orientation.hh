...
class Orientation
{
    JEOD_MAKE_SIM_INTERFACES(jeod, Orientation)
...
public:
    ...
    virtual void compute_transform();
    virtual void compute_quaternion();
    virtual void compute_eigen_rotation();
    virtual void compute_euler_angles();

    virtual void compute_all_products();
    virtual void compute_transformation_and_quaternion();
...
protected:
    ...
    void compute_matrix_from_euler_angles();
    void compute_euler_angles_from_matrix();
    void compute_matrix_from_eigen_rotation();
    void compute_eigen_rotation_from_matrix();
...
public:
     ...
     * quaternion.
     */
    DataSource data_source{InputMatrix}; //!< trick_units(--)

    /**
     * The Euler rotation sequence corresponding to euler_angles.
     */
    EulerSequence euler_sequence{NoSequence}; //!< trick_units(--)
 ...
 */
inline void Orientation::compute_quaternion_from_euler_angles()
{
 ...
 * provided Euler rotation sequence.
 */
inline void Orientation::compute_matrix_from_euler_angles()
{
 ...
 */
inline void Orientation::compute_euler_angles_from_matrix()
{
 ...
 */
inline void Orientation::compute_matrix_from_eigen_rotation()
{
 ...
 * provided transformation matrix.
 */
inline void Orientation::compute_eigen_rotation_from_matrix()
{
