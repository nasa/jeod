 ...
 */
void Orientation::compute_matrix_from_eigen_rotation(double eigen_angle, const double eigen_axis[3], double trans[3][3])
{
 ...
 */
void Orientation::compute_eigen_rotation_from_matrix(const double trans[3][3],
                                                     double * eigen_angle,
                                                     double eigen_axis[3])
{
