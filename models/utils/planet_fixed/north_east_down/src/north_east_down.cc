 ...
 */
void NorthEastDown::update_from_cart(const double cart[3])
{
 ...
 */
void NorthEastDown::update_from_spher(const AltLatLongState & spher)
{
 ...
 */
void NorthEastDown::update_from_ellip(const AltLatLongState & ellip)
{
...
void NorthEastDown::build_ned_orientation()
{
    ...
    else
    {
        MessageHandler::fail(__FILE__,
                             __LINE__,
                             PlanetFixedMessages::invalid_request,
 ...
 */
void NorthEastDown::set_ned_trans_states(const double pos[3], const double vel[3])
{
