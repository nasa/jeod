...
void randomVector(PlanetFixedPosition & p, double r1, double r2, double rv[3]);
int getEllipticalParams(Planet & p, double r, double z, double & f, double & h, int maxIters = 10);
...
void doTest(PlanetFixedPosition & pfp, double carts[3], double & eSphere, double & eEllipse)
{
...
void randomVector(PlanetFixedPosition & pfp, double lowR, double highR, double rv[3])
{
