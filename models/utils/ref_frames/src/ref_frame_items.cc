 ...
 */
std::string RefFrameItems::to_string(Items test_items)
{
    const char * name;
    ...
    switch(test_items)
    {
        ...
        case Att:
            ...
            break;
        case Pos_Att:
            name = "position, attitude";
            break;
        case Vel_Att:
            name = "velocity, attitude";
            break;
        case Pos_Vel_Att:
            name = "position, velocity, attitude";
            break;
        case Rate:
            name = "rate";
            break;
        ...
        case Vel_Rate:
            ...
            break;
        case Pos_Vel_Rate:
            name = "position, velocity, rate";
            break;
        case Att_Rate:
            name = "attitude, rate";
            break;
        case Pos_Att_Rate:
            name = "position, attitude, rate";
            break;
        case Vel_Att_Rate:
            name = "velocity, attitude, rate";
            break;
        case Pos_Vel_Att_Rate:
            name = "position, velocity, attitude, rate";
            break;
        default:
            name = "unknown items";
            break;
 ...
 */
RefFrameItems::RefFrameItems(Items new_value)
{
    value = new_value;
}
 ...
 * @return Set items, by name
 */
std::string RefFrameItems::to_string() const
{
