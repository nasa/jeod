...
The \ModelDesc provides a generic bridge between the other models that 
comprise JEOD and a simulation environment where those models are used.
The  \ModelDesc uses abstract classes to specify contracts between JEOD
