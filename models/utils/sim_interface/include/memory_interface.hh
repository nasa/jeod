...
{
    JEOD_MAKE_SIM_INTERFACES(jeod, JeodMemoryInterface)
...
public:
    ...
    explicit JeodMemoryInterface(const JeodMemoryInterface &) = default;
     ...
     */
    virtual const JEOD_ATTRIBUTES_POINTER_TYPE find_attributes(const std::string & type_name) const = 0;
     ...
     * \return Attributes pointer. Note: This is not an allocated pointer.
     */
    virtual const JEOD_ATTRIBUTES_POINTER_TYPE find_attributes(const std::type_info & data_type) const = 0;
     ...
     */
    virtual JEOD_ATTRIBUTES_TYPE primitive_attributes(const std::type_info & data_type) const = 0;
     ...
     */
    virtual JEOD_ATTRIBUTES_TYPE pointer_attributes(const JEOD_ATTRIBUTES_TYPE & pointed_to_attr) const = 0;

    /**
     * Create a simulation engine description of void*.
     * \return Attribute structure.
     */
    virtual JEOD_ATTRIBUTES_TYPE void_pointer_attributes() const = 0;
     ...
     * \return Attribute structure.
     */
    virtual JEOD_ATTRIBUTES_TYPE structure_attributes(const JEOD_ATTRIBUTES_POINTER_TYPE target_attr,
     ...
     */
    virtual void register_container(const void * container,
     ...
     * \param[in,out] checkpointable The checkpointable object itself
     */
    virtual void deregister_container(const void * container,
                                      const JeodMemoryTypeDescriptor & container_type,
                                      const std::string & elem_name,
                                      JeodCheckpointable & checkpointable) = 0;
