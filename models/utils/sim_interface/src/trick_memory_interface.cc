 ...
 */
void
JeodTrickMemoryInterface::set_mode (
 ...
 */
std::string
JeodTrickMemoryInterface::construct_identifier (
   uint32_t unique_id_number)
{
   ...
   sstream << id_prefix
           << std::setfill('0') << std::setw (id_length) << unique_id_number;
   return sstream.str();
 ...
 */
void
JeodTrickMemoryInterface::register_container (
   const void * owner JEOD_UNUSED,
 ...
 */
void
JeodTrickMemoryInterface::deregister_container (
   const void * owner JEOD_UNUSED,
   const JeodMemoryTypeDescriptor & owner_type JEOD_UNUSED,
   const char * elem_name JEOD_UNUSED,
   JeodCheckpointable & container JEOD_UNUSED)
 ...
 */
const std::string
JeodTrickMemoryInterface::get_name_at_address (
 ...
 */
void *
JeodTrickMemoryInterface::get_address_at_name (
