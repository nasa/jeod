...
class Facet {
   ...
   JEOD_MAKE_SIM_INTERFACES(Facet)
...
public:
   ...
   virtual void initialize_mass_connection (
    ...
    */
   MassPointState * get_mass_rel_struct () {return mass_rel_struct;}
    ...
    */
   char * mass_body_name; //!< trick_units(--)
