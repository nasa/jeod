...
def set_launch_stack(dynamics, dm_mass, lm_dyn, sm_dyn, cm_dyn, s3_dyn, s2_dyn, s1_dyn, les_dyn) :
  ...
  #/**********************************************************/
  dm_mass.mass_attach.subject = dm_mass.body
  dm_mass.mass_attach.parent  = lm_dyn.dyn_body.mass
  ...
  sm_dyn.mass_attach.subject = sm_dyn.dyn_body.mass
  sm_dyn.mass_attach.parent  = cm_dyn.dyn_body.mass
  ...
  s3_dyn.mass_attach.subject = s3_dyn.dyn_body.mass
  s3_dyn.mass_attach.parent  = sm_dyn.dyn_body.mass
  ...
  lm_dyn.mass_attach.subject = lm_dyn.dyn_body.mass
  lm_dyn.mass_attach.parent  = s3_dyn.dyn_body.mass
  ...
  s2_dyn.mass_attach.subject = s2_dyn.dyn_body.mass
  s2_dyn.mass_attach.parent  = s3_dyn.dyn_body.mass
  ...
  s1_dyn.mass_attach.subject = s1_dyn.dyn_body.mass
  s1_dyn.mass_attach.parent  = s2_dyn.dyn_body.mass
  ...
  les_dyn.mass_attach.subject = les_dyn.dyn_body.mass
  les_dyn.mass_attach.parent  = cm_dyn.dyn_body.mass
