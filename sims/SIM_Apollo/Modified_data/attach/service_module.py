...
def set_service_module(sv_dyn_reference) :
  ...
  sv_dyn_reference.mass_init.get_mass_point(0).set_name("Stage 3 interface")
  sv_dyn_reference.mass_init.get_mass_point(0).pt_frame_spec    = trick.MassPointInit.StructToBody
  sv_dyn_reference.mass_init.get_mass_point(0).position  = trick.attach_units( "ft",[ -20.9, 0.0, 0.0])
  ...
  sv_dyn_reference.mass_init.get_mass_point(1).set_name("CM interface")
  sv_dyn_reference.mass_init.get_mass_point(1).pt_frame_spec    = trick.MassPointInit.StructToBody
  sv_dyn_reference.mass_init.get_mass_point(1).position  = trick.attach_units( "ft",[ 24.6, 0.0, 0.0])
