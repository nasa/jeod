...
def set_stage_1(sv_dyn_reference) :
  ...
  sv_dyn_reference.mass_init.allocate_points(1)


  #/* Set the mass point interface position and orientation. */
  sv_dyn_reference.mass_init.get_mass_point(0).set_name("Stage 2 interface")
  sv_dyn_reference.mass_init.get_mass_point(0).pt_frame_spec    = trick.MassPointInit.StructToBody
  sv_dyn_reference.mass_init.get_mass_point(0).position  = trick.attach_units( "ft",[ 138.0, 0.0, 0.0])
  sv_dyn_reference.mass_init.get_mass_point(0).pt_orientation.data_source     =    trick.Orientation.InputEigenRotation


  sv_dyn_reference.mass_init.get_mass_point(0).pt_orientation.eigen_angle  = 0.0
