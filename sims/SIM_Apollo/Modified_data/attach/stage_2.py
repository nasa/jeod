...
def set_stage_2(sv_dyn_reference) :
  ...
  sv_dyn_reference.mass_init.points[0].set_name("Stage 1 interface")
  ...
  sv_dyn_reference.mass_init.points[1].set_name("Stage 3 interface")
  sv_dyn_reference.mass_init.points[1].pt_frame_spec    = trick.MassPointInit.StructToBody
  sv_dyn_reference.mass_init.points[1].position  = trick.attach_units( "ft",[ 81.5, 0.0, 0.0])
