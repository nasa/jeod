...
def set_stage_3(sv_dyn_reference) :
  ...
  sv_dyn_reference.mass_init.get_mass_point(1).set_name("LEM/SM/CM interface")
  sv_dyn_reference.mass_init.get_mass_point(1).pt_frame_spec    = trick.MassPointInit.StructToBody
  sv_dyn_reference.mass_init.get_mass_point(1).position  = trick.attach_units( "ft",[ 61.3, 0.0, 0.0])
