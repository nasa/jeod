...
class CmdlineParser {
 ...
 private:
    ...
    * Not implemented.
    */
   explicit CmdlineParser (const CmdlineParser &);
 ...
 private:
   ...
   class BaseOptionValue {
    ...
    public:
       ...
       */
      virtual bool takes_argument (void) = 0;
   ...
   class ToggleOptionValue : public SwitchOptionValue {
    ...
    public:
       ...
       * Set the target to the default value for the option.
       */
      virtual void set_default (void) { target = default_value; }
   ...
   class CounterOptionValue : public BaseIntOptionValue {
    ...
    public:
       ...
       */
      virtual void set_default (void) { target = 0; }
   ...
   class StringOptionValue : public BaseOptionValue {
    ...
    public:
       ...
       */
      virtual bool takes_argument (void) { return true; }
       ...
       * option argument.
       */
      virtual void parse_value (const char * arg) { target = arg; }
