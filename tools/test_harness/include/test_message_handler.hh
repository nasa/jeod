...
{
    JEOD_MAKE_SIM_INTERFACES(jeod, TestMessageHandler)
...
public:
    ...
    TestMessageHandler(const TestMessageHandler &) = delete;
    TestMessageHandler & operator=(const TestMessageHandler &) = delete;
