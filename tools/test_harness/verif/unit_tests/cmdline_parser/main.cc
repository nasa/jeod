...
int main(int argc, char ** argv)
{
    ...
    const char * string = nullptr; // Associated with -string
    ...
    if((argc != 2) || (std::strlen(argv[1]) != 1) || (argv[1][0] < '0') || (argv[1][0] > '9'))
    {
        MessageHandler::fail(__FILE__, __LINE__, TestHarnessMessages::inconsistent_setup, "Inconsistent test setup");
    }
    ...
    std::printf("Test #%s retrieved command line option values:\n"
                ...
                "  number   = %.15f\n",
                argv[1],
                trueFalseStrings[index1],
                trueFalseStrings[index2],
                counter,
                string,
                integer,
                number);
    ...
    switch(argv[1][0])
    {
            // Test 0: ./main.exe 0
        case '0':
            if((simple_switch) || (!toggle) || (counter != 0) || (string[0] != '\0') || (integer != 0) || (number != 0))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
                                     TestHarnessMessages::invalid_option,
                                     "Unexpected results for test #%s",
                                     argv[1]);
            }
            break;
        ...
        case '1':
            if((!simple_switch) || (!toggle) || (counter != 0) || (string[0] != '\0') || (integer != 0) ||
               (number != 0))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
        ...
        case '4':
            if((simple_switch) || (!toggle) || (counter != 1) || (string[0] != '\0') || (integer != 0) || (number != 0))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
                                     TestHarnessMessages::invalid_option,
        ...
        case '5':
            if((simple_switch) || (!toggle) || (counter != 2) || (string[0] != '\0') || (integer != 0) || (number != 0))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
                                     TestHarnessMessages::invalid_option,
        ...
        case '6':
            if((simple_switch) || (!toggle) || (counter != 0) || (std::strcmp(string, "hello") != 0) ||
               (integer != 0) || (number != 0))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
        ...
        case '7':
            if((simple_switch) || (!toggle) || (counter != 0) || (string[0] != '\0') || (integer != 42) ||
               (number != 0))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
        ...
        case '9':
            if((!simple_switch) || (toggle) || (counter != 2) || (std::strcmp(string, "hello") != 0) ||
               (integer != 42) || (std::abs(number - M_PI) > 1e-15))
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
                                     TestHarnessMessages::invalid_option,
        ...
        default:
            MessageHandler::fail(__FILE__, __LINE__, TestHarnessMessages::inconsistent_setup, "This can't happen.");
            break;
    }
