    ...
    switch(argv[1][0])
    {
        ...
        case '2':
            ...
            if(sim_interface.get_allowed_count() != 0)
            {
                MessageHandler::fail(__FILE__,
                                     __LINE__,
                                     TestHarnessMessages::test_failed,
            ...
            {
                MessageHandler::inform(__FILE__, __LINE__, TestHarnessMessages::debug, "That worked.");
            }
            ...
            {
                MessageHandler::inform(__FILE__, __LINE__, TestHarnessMessages::debug, "That worked. Test passes.");
                return 0;
            }
            break;
        ...
        case '4':
            MessageHandler::inform(__FILE__, __LINE__, TestHarnessMessages::debug, "Marking '' as a verboten code.");
