#/*****************************************************************************
#   Run #10B: Rot State Comparison: Gravity Gradient, Circular, Initial Rate
#******************************************************************************
#
#Description:
# This test is the same as 10A except that there is an initial attitude rate
# of 0.01 deg/s on the LVLH pitch axis with this one.
